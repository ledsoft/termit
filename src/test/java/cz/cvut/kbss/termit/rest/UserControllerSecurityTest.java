...
class UserControllerSecurityTest extends BaseControllerTestRunner {
    ...
    void unlockThrowsForbiddenForNonAdmin() throws Exception {
        ...
        mockMvc.perform(
                delete(BASE_URL + "/lock").param(ID_QUERY_PARAM, toUnlock.getUri().toString())
    ...
    void enableThrowsForbiddenForNonAdmin() throws Exception {
        ...
        mockMvc.perform(post(BASE_URL + "/status").param(ID_QUERY_PARAM, toEnable.getUri().toString()))
               .andExpect(status().isForbidden());
    ...
    void disableThrowsForbiddenForNonAdmin() throws Exception {
        ...
        mockMvc.perform(delete(BASE_URL + "/status").param(ID_QUERY_PARAM, toDisable.getUri().toString()))
               .andExpect(status().isForbidden());
